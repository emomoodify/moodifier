...
class SLConfig(object):
    ...
    Example:
        ...
        >>> cfg.b.b1
        [0, 1]
        >>> cfg = Config.fromfile('tests/json_data/config/a.py')
        >>> cfg.filename
        "/home/kchen/projects/mmcv/tests/json_data/config/a.py"
        >>> cfg.item4
        'test'
        >>> cfg
        "Config [path: /home/kchen/projects/mmcv/tests/json_data/config/a.py]: "
