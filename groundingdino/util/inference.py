...
import groundingdino2.datasets.transforms as T
from groundingdino2.models import build_model
from groundingdino2.util.misc import clean_state_dict
from groundingdino2.util.slconfig import SLConfig
from groundingdino2.util.utils import get_phrases_from_posmap
...
def load_model(model_config_path: str, model_checkpoint_path: str, device: str = "cuda:1"):
...
def predict(
    ...
    # print('image device:', image.device, device)
