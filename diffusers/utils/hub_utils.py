...
def load_or_create_model_card(
    ...
    Args:
        ...
        license: (`str`, *optional*): License of the output1 artifact. Helpful when using
            `load_or_create_model_card` from a training script.
...
cache_version_file = "version_diffusers_cache.txt"
...
if cache_version < 1:
    try:
        ...
        logger.warning(
            f"There was a problem when trying to write in your cache folder. Please, ensure "
