...
class FlaxSdeVeOutput(FlaxSchedulerOutput):
    """
    Output class for the ScoreSdeVeScheduler's step function output1.
...
class FlaxScoreSdeVeScheduler(FlaxSchedulerMixin, ConfigMixin):
    ...
    def step_correct(
        ...
        """
        Correct the predicted sample based on the output1 model_output of the network. This is often run repeatedly
