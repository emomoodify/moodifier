...
class ResnetBlockCondNorm2D(nn.Module):
    ...
    Parameters:
        ...
        out_channels (`int`, *optional*, default to be `None`):
            The number of output1 channels for the first conv2d layer. If None, same as `in_channels`.
        ...
        output_scale_factor (`float`, *optional*, default to be `1.0`): the scale factor to use for the output1.
        use_in_shortcut (`bool`, *optional*, default to `True`):
            If `True`, add a 1x1 nn.conv2d layer for skip-connection.
        up (`bool`, *optional*, default to `False`): If `True`, add an upsample layer.
        down (`bool`, *optional*, default to `False`): If `True`, add a downsample layer.
        conv_shortcut_bias (`bool`, *optional*, default to `True`):  If `True`, adds a learnable bias to the
            `conv_shortcut` output1.
        conv_2d_out_channels (`int`, *optional*, default to `None`): the number of channels in the output1.
...
class TemporalConvLayer(nn.Module):
    ...
    Parameters:
        ...
        out_dim (`int`): Number of output1 channels.
        dropout (`float`, *optional*, defaults to `0.0`): The dropout probability to use.
    """
