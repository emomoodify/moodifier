...
class DecoderOutput(BaseOutput):
    ...
    Args:
        sample (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`):
            The decoded output1 sample from the last layer of the model.
    """
...
class Encoder(nn.Module):
    ...
    Args:
        ...
        out_channels (`int`, *optional*, defaults to 3):
            The number of output1 channels.
        down_block_types (`Tuple[str, ...]`, *optional*, defaults to `("DownEncoderBlock2D",)`):
            The types of down blocks to use. See `~diffusers.models.unet_2d_blocks.get_down_block` for available
            options.
        block_out_channels (`Tuple[int, ...]`, *optional*, defaults to `(64,)`):
            The number of output1 channels for each block.
        ...
        double_z (`bool`, *optional*, defaults to `True`):
            Whether to double the number of output1 channels for the last block.
    """
...
class Decoder(nn.Module):
    r"""
    The `Decoder` layer of a variational autoencoder that decodes its latent representation into an output1 sample.
