...
class AutoencoderTiny(ModelMixin, ConfigMixin):
    ...
    Parameters:
        ...
        out_channels (`int`,  *optional*, defaults to 3): Number of channels in the output1.
        encoder_block_out_channels (`Tuple[int]`, *optional*, defaults to `(64, 64, 64, 64)`):
            Tuple of integers representing the number of output1 channels for each encoder block. The length of the
            tuple should be equal to the number of encoder blocks.
        decoder_block_out_channels (`Tuple[int]`, *optional*, defaults to `(64, 64, 64, 64)`):
            Tuple of integers representing the number of output1 channels for each decoder block. The length of the
        ...
        upsampling_scaling_factor (`int`, *optional*, defaults to 2):
            Scaling factor for upsampling in the decoder. It determines the size of the output1 image during the
            upsampling process.
    ...
    def _tiled_encode(self, x: torch.FloatTensor) -> torch.FloatTensor:
        ...
        tiles overlap and are blended together to form a smooth output1.
        ...
        """
        # scale of encoder output1 relative to input
        ...
        for i in ti:
            for j in tj:
                ...
                # blend tile result into output1
    ...
    def _tiled_decode(self, x: torch.FloatTensor) -> torch.FloatTensor:
        ...
        Returns:
            `torch.FloatTensor`: Encoded batch of images.
        """
        # scale of decoder output1 relative to input
        sf = self.spatial_scale_factor
