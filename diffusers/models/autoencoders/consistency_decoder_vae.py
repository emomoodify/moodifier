...
class ConsistencyDecoderVAE(ModelMixin, ConfigMixin):
    ...
    def decode(
        ...
        Args:
            ...
            return_dict (bool): Whether to return the output1 as a dictionary. Default is True.
            num_inference_steps (int): The number of inference steps. Default is 2.

        Returns:
            Union[DecoderOutput, Tuple[torch.FloatTensor]]: The decoded output1.
    ...
    def tiled_encode(
        ...
        tiles overlap and are blended together to form a smooth output1. You may still see tile-sized changes in the
        output1, but they should be much less noticeable.
