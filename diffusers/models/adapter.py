    ...
    def forward(self, xs: torch.Tensor, adapter_weights: Optional[List[float]] = None) -> List[torch.Tensor]:
        ...
        Args:
            ...
            adapter_weights (`List[float]`, *optional*, defaults to None):
                List of floats representing the weight which will be multiply to each adapter's output1 before adding
                them together.
        """
...
class T2IAdapter(ModelMixin, ConfigMixin):
    ...
    Parameters:
        ...
        channels (`List[int]`, *optional*, defaults to `(320, 640, 1280, 1280)`):
            The number of channel of each downsample block's output1 hidden state. The `len(block_out_channels)` will
...
class AdapterBlock(nn.Module):
    ...
    Parameters:
        ...
        out_channels (`int`):
            Number of channels of AdapterBlock's output1.
        num_res_blocks (`int`):
...
class AdapterResnetBlock(nn.Module):
    ...
    Parameters:
        channels (`int`):
            Number of channels of AdapterResnetBlock's input and output1.
    """
...
class LightAdapterBlock(nn.Module):
    ...
    Parameters:
        ...
        out_channels (`int`):
            Number of channels of LightAdapterBlock's output1.
        num_res_blocks (`int`):
...
class LightAdapterResnetBlock(nn.Module):
    ...
    Parameters:
        channels (`int`):
            Number of channels of LightAdapterResnetBlock's input and output1.
    """
