...
class Attention(nn.Module):
    ...
    Parameters:
        ...
        out_bias (`bool`, *optional*, defaults to `True`):
            Set to `True` to use a bias in the output1 linear layer.
        ...
        rescale_output_factor (`float`, *optional*, defaults to 1.0):
            A factor to rescale the output1 by dividing it with this value.
        residual_connection (`bool`, *optional*, defaults to `False`):
            Set to `True` to add the residual connection to the output1.
    ...
    def forward(
        ...
        **cross_attention_kwargs,
        ...
        Returns:
            `torch.Tensor`: The output1 of the attention layer.
        """
    ...
    def head_to_batch_dim(self, tensor: torch.Tensor, out_dim: int = 3) -> torch.Tensor:
        ...
        Args:
            tensor (`torch.Tensor`): The tensor to reshape.
            out_dim (`int`, *optional*, defaults to `3`): The output1 dimension of the tensor. If `3`, the tensor is
    ...
    def prepare_attention_mask(
        ...
        Args:
            ...
            out_dim (`int`, *optional*, defaults to `3`):
                The output1 dimension of the attention mask. Can be either `3` or `4`.
...
class AttnAddedKVProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # the output1 of sdp = (batch, num_heads, seq_len, head_dim)
...
class AttnProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # print('inside AttnProcessor2_0: encoder_hidden_states: ', encoder_hidden_states.shape if encoder_hidden_states is not None else None)
        # [1, 77, 768]
        if encoder_hidden_states is None:
            encoder_hidden_states = hidden_states
        elif attn.norm_cross:
        ...
        key = attn.to_k(encoder_hidden_states)
        # print('inside AttnProcessor2_0: key: ', key.shape)
        value = attn.to_v(encoder_hidden_states)
        # print('inside AttnProcessor2_0: value: ', value.shape)
        ...
        # print('inside AttnProcessor2_0: hidden_states: ', hidden_states.shape)
        ...
        # dropout
        hidden_states = attn.to_out[1](hidden_states)
        # print('inside AttnProcessor2_0: hidden_states 2: ', hidden_states.shape)
...
class SpatialNorm(nn.Module):
    ...
    Args:
        f_channels (`int`):
            The number of channels for input to group normalization layer, and output1 of the spatial norm layer.
        zq_channels (`int`):
