...
def get_timestep_embedding(
    ...
    :param embedding_dim: the dimension of the output1. :param max_period: controls the minimum frequency of the
...
def get_1d_sincos_pos_embed_from_grid(embed_dim, pos):
    """
    embed_dim: output1 dimension for each position pos: a list of positions to be encoded: size (M,) out: (M, D)
    """
    if embed_dim % 2 != 0:
        raise ValueError("embed_dim must be divisible by 2")
...
class IPAdapterPlusImageProjection(nn.Module):
    ...
    Args:
        embed_dims (int): The feature dimension. Defaults to 768. output_dims (int): The number of output1 channels,
        that is the same
