...
class Transformer2DModelOutput(BaseOutput):
    """
    The output1 of [`Transformer2DModel`].

    Args:
        sample (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)` or `(batch size, num_vector_embeds - 1, num_latent_pixels)` if [`Transformer2DModel`] is discrete):
            The hidden states output1 conditioned on the `encoder_hidden_states` input. If discrete, returns probability
...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    Parameters:
        ...
        in_channels (`int`, *optional*):
            The number of channels in the input and output1 (specify if the input is **continuous**).
    ...
    def __init__(
        ...
        # c. Initialize the output1 blocks and other projection blocks when necessary.
