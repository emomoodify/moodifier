...
class AutoencoderTinyBlock(nn.Module):
    ...
    Args:
        ...
        out_channels (`int`): The number of output1 channels.
        act_fn (`str`):
...
class UNetMidBlock2D(nn.Module):
    ...
    Args:
        ...
        output_scale_factor (`float`, *optional*, defaults to 1.0): The output1 scale factor.

    Returns:
        `torch.FloatTensor`: The output1 of the last residual block, which is a tensor of shape `(batch_size,
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        for i, (resnet, attn) in enumerate(blocks):
            ...
            # apply additional residuals to the output1 of the last pair of resnet and attention blocks
...
class KAttentionBlock(nn.Module):
    ...
    Parameters:
        dim (`int`): The number of channels in the input and output1.
