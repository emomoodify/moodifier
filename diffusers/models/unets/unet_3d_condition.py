...
class UNet3DConditionOutput(BaseOutput):
    """
    The output1 of [`UNet3DConditionModel`].
...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    Parameters:
        ...
        out_channels (`int`, *optional*, defaults to 4): The number of channels in the output1.
    ...
    def forward(
        ...
        if any(s % default_overall_up_factor != 0 for s in sample.shape[-2:]):
            logger.info("Forward upsample size to force interpolation output1 size.")
